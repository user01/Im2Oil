...
def K_Means_Sampler(
    ...
    if True:
        ...
        if save:
            ...
            cv2.imwrite(
                output_dir + "/density_map.png",
                255 - density_map[border_copy:-border_copy, border_copy:-border_copy],
            )
            if display == True:
